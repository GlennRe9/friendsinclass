...
<div class="container">
<form action="#" name="passwordform" method="post" onsubmit=" return !!(validatePassword() && blankPassword() && passwordCheck())">
<table>
<tr>
...
<td><p id="equalpasswords2"></p><input type="password" name="Password2"/> <input type="Submit" value="Save" style="width:16%"></td>
<td></td>
</tr>
</table>
...
function passwordCheck() {
      ...
      if (document.passwordform.inputedPassword.value == password)
      {
              ...
              var newpassvalue = document.passwordform.Password2.value;              //alert("paswordcheck "+newpassvalue);
              return submitPass(newpassvalue);      
...
<script>
function submitPass(newpassvalue) {
     // Creating a XMLHttpRequest Object... Both the if-else is required because this object is      // created differently in different browser Type... If this code does not work.... Let me know      // which brower the code is being run...
	...
	// The above alert should show [object]. If it shows null or undefined, there is a problem         // right here

	// Below is the callback function. When ever the code is ready this code will automatically 	// get called
        ...
        xmlhttp.open("GET","updatepassword.php?value="+newpassvalue,true);
        xmlhttp.send();
    }
